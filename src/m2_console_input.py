...
def double_a_float():
    ...
    floating_point = float(input('Enter a number: '))
    print(2 * floating_point)
...
def input_it_all():
    ...
    floating_point = float(input('Enter a positive floating point number: '))
    integer = int(input('Enter a positive integer: '))
    string = input('Enter a string: ')
    for k in range(integer):
        print(math.sqrt(floating_point))
    for k in range(integer):
        print(string)
